        ...
        <section className="relative h-[80vh] overflow-hidden bg-white">
            ...
            <div className="relative z-10 container mx-auto px-6 h-full flex items-end pb-16">
                <div className="max-w-3xl space-y-6">
                    ...
                    <div className="flex items-center gap-4">
                        <button className="px-8 py-3 border-2 border-[#fbd203] text-[#fbd203] hover:bg-[#fbd203] hover:text-white transition-all uppercase tracking-wider text-sm font-bold flex items-center gap-2 group rounded-lg">
                            Read Review

...
import CategoryPageComponent from "../catagory/[slug]/CategoryPage"
...
export default async function CategoryPage({ params }: Props) {
  ...
  const posts: BlogPostDocument[] = await client.getAllByType("blog_post", {
    predicates: [
      prismic.filter.at("my.blog_post.category", params.catagory),
    ],
    orderings: [
  ...
  return (
    <CategoryPageComponent
      categoryName={params.catagory.charAt(0).toUpperCase() + params.catagory.slice(1)}

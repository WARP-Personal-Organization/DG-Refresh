      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-4">
              <p className="text-gray-300 leading-relaxed text-sm max-w-2xl">
                ...
                Bacolod, Antique, and Manila. Led by Iloilo&apos;s most
                respected journalists, the Daily Guardian pledges to tell the
                Ilonggo story as seen through the various lenses of society so
                that every side may be told.
              </p>
          ...
          <div className="space-y-6">
            ...
            {/* Newsletter Signup */}
            <div className="space-y-3">
              <h4 className="text-white font-semibold font-serif">
                Daily Newsletter
              </h4>
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          ...
          <div className="mt-6 pt-4 border-t border-gray-900 text-center">
            <div className="flex items-center justify-center gap-2 text-gray-600">
              ...
              <span className="text-sm font-medium">
                Committed to Truth, Dedicated to Community
              </span>
            </div>
          </div>
        </div>
